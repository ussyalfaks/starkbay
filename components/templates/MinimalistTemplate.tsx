...
export const MinimalistTemplate = ({ storeData, products = [] }: MinimalistTemplateProps) => {
  ...
  const defaultProducts = [
    ...
    },
    {
      ...
      price: 59.99,
      image: "https://images.unsplash.com/photo-1612196808214-5b19cbb14325?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              {storeData.logo ? (
                <Image width={50} height={50} src={storeData.logo} alt={storeData.name} className="h-8 w-8 object-contain" />
              ) : (
                <div className="h-8 w-8 bg-gray-200 rounded-full"></div>
              )}
              <span className="text-xl font-bold">{storeData.name || "Store Name"}</span>
            </div>
        ...
        <div className="md:hidden bg-white shadow-lg absolute z-40 w-full">
          <div className="container mx-auto px-4 py-4">
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-800 hover:text-gray-600 block py-2">Home</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-gray-600 block py-2">Products</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-gray-600 block py-2">About</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-gray-600 block py-2">Contact</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-gray-600 block py-2">Account</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section 
        ...
        style={{
          backgroundImage: storeData.banner ? `url(${storeData.banner})` : 'none',
        ...
        <div className="container mx-auto px-4 z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white/90 mb-6">
              {storeData.description || "Discover our unique collection of high-quality products."}
            </p>
      ...
      <footer className="bg-white border-t border-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {storeData.description || "We're dedicated to providing the best products and shopping experience."}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {["Home", "Products", "About Us", "Terms of Service", "Privacy Policy"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-gray-600 hover:text-black">{item}</a>
                  </li>
                ))}
            ...
            <div>
              ...
              <div className="flex gap-4">
                {["Facebook", "Instagram", "Twitter"].map((platform) => (
                  <a key={platform} href="#" className="text-gray-600 hover:text-black text-sm">
                    {platform}
                  </a>
                ))}
              </div>
          ...
          <div className="border-t border-gray-100 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">
              &copy; {new Date().getFullYear()} {storeData.name || "Store Name"}. All rights reserved.
            </p>
